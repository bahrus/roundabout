 ...
 */
async function setupPositraction(vm, positraction) {
    const vmAny = vm;
 ...
 */
async function executePositraction(vm, positraction) {
    const vmAny = vm;
 ...
 */
function buildArguments(vm, positraction) {
    const vmAny = vm;
 ...
 */
function assignResults(vm, result, assignTo) {
    const vmAny = vm;
